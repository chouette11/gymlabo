...
abstract class $TaskEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, DateTime deadline});
}
...
class _$_TaskEntity extends _TaskEntity {
  const _$_TaskEntity(
      {required this.id, required this.title, required this.deadline})
      : super._();
  ...
  @override
  String toString() {
    return 'TaskEntity(id: $id, title: $title, deadline: $deadline)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, title, deadline);
...
abstract class _TaskEntity extends TaskEntity {
  const factory _TaskEntity(
      ...
      required final DateTime deadline}) = _$_TaskEntity;
