...
def make_slide_topic(class_text):
    # 本文から目次を抽出 
    ...
    img2 = cv2.imread('./slide_topic/image' + str(0) +'.jpg')
    img3 = cv2.imread('./slide_topic/image' + str(1) + '.jpg')
    img4 = cv2.imread('./slide_topic/image' + str(2) + '.jpg')
    ...
    cv2.imwrite('slide_topic/image.jpg', large_img)
